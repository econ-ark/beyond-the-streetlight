...
df = pd.DataFrame({"Unemployment": unemp.data,
...
print(df.head)
df.to_csv('/Users/dc/Library/CloudStorage/OneDrive-JohnsHopkins/research/GitHub/dedwar65/RS100_Discussion/Fred.csv')
#df.to_excel('/Users/dc/Library/CloudStorage/OneDrive-JohnsHopkins/research/GitHub/dedwar65/RS100_Discussion/FRED_scraped.xlsx', index=False)